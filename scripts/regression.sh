...
python3 dpfn/experiments/compare_abm.py --inference_method "fn" --simulator abm --config_data intermediate_graph_abm_02 --config_model model_ABM01  --name regression
