...
srun python3 dpfn/main.py --online_mse --num_time_steps 10 --app_users_fraction 0.6 --name=error_test_online --mean_baseline --num_users 100000 --seed_value 30 --inference_method "fn" --simulator abm --config_data intermediate_graph_abm_02 --config_model model_ABM01