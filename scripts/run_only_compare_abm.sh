...
srun python3 dpfn/main.py --app_users_fraction 0.6 --name=static_mean_test --mean_baseline --static_baseline --num_users 10000 --seed_value 99 --inference_method "fn" --simulator abm --config_data intermediate_graph_abm_02 --config_model model_ABM01