...
srun python3 dpfn/main.py --model gcn --seed_value 45 --app_users_fraction 0.4 --name=random_test --config_data=intermediate_graph_abm_02 --simulator=abm --inference_method=fn
